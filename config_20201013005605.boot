interfaces {
    ethernet eth0 {
        address dhcp
        hw-id 08:00:27:8d:84:0d
    }
    ethernet eth1 {
        address 192.168.0.7/24
        hw-id 08:00:27:6f:cf:7f
    }
}
service {
    ssh {
...
system {
    ...
    login {
        user vyos {
            authentication {
                encrypted-password $6$y23zdlUpHp.Ho$C7.OFMLVVddVa1HkilozZEc14FoaLZZVgN3Aah54AHd9XwmjSBK7VTrM3nYLJuyUETSLKi80jbwcfsdOXSkoM/
                plaintext-password ""
            }
        }
    }
...
// Release version: 1.3-rolling-202006230700